...
(async () => {
  ...
  const url = 'https://www.gaudinporschelv.com';
  await page.goto(url);
  console.log('landed')
...
const srpCpoUrl = 'certified-pre-owned.html'
const couponsUrl = 'servicespecials.html'
const financingUrl = 'finance.aspx'
const serviceUrl = 'schedule-appointment.html'
const partsUrl = 'Gaudin-Porsche-of-Las-Vegas-Parts.html'
const contactUrl = 'contactus.aspx'
const ValueYourTradeUrl = 'true-cash-offer'

//* Btn Classes

const SRPePriceVar = '#pricing-stack'

const srpNewImg = '.vehicleImg'


const VDPePriceVar = '#pricing-stack'

const VDPShoppingTools = '.ae-exclude'

const testDrive = '.schedule-testdrive'
...
const testDriveVar = 'input#submit'
