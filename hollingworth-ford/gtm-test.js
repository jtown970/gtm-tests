...
(async () => {
  ...
  const url = 'https://www.hollingsworthrichardsford.com';
  await page.goto(url);
  console.log('landed')
...
const couponsUrl = 'parts-service-coupons/index.htm'
const financingUrl = 'financing/application.htm'
const serviceUrl = 'service-scheduler.htm'
const partsUrl = 'parts/index.htm'
const contactUrl = 'contact.htm'

//* Btn Classes

const SRPePriceVar = '.mycars-add-alert-btn'


const srpNewImg = 'div.media a img'
