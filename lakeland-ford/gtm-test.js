...
(async () => {
  ...
  const url = 'https://www.lakelandford.com';
  await page.goto(url);
  console.log('landed')
...
//* URL
const srpNewUrl = 'inventory/new-vehicles/'
const srpUsedUrl = 'inventory/used-vehicles/'
const couponsUrl = 'service-specials/'
const financingUrl = 'finance/'
const serviceUrl = 'service-center/'
const partsUrl = 'parts-center/'
const contactUrl = 'contact-us/'

//* Btn Classes

const SRPePriceVar = 'div.pa2 a.NewButton div.eprice'
const SRPePriceVar2 = 'div.pa2 a.cn-buy-now div.eprice'


const srpNewImg = 'div.relative a img'


const VDPePriceVar = '.eprice'
...
const printBtn = '.EventType-print-offer'

const valueYourTradeVar = '.tp-btn-full-frame'

//* Form Submit Classes
const formClass = '.gform_button'

const testDriveVar = 'input.button'

const partsFormVar = '.gform_button'

const contactFormVar = '.gform_button'

const financingFormVar = '#gform_submit_button_117'

const serviceFormVar = '.pagebanner-buttons'
